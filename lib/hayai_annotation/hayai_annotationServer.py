...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'hayai_annotation'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from hayai_annotation.hayai_annotationImpl import hayai_annotation  # noqa @IgnorePep8
impl_hayai_annotation = hayai_annotation(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'hayai_annotation'
