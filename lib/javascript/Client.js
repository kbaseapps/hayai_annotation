...
function hayai_annotation(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.hayai_annotation = function (input, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "hayai_annotation.hayai_annotation",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "hayai_annotation.status",
