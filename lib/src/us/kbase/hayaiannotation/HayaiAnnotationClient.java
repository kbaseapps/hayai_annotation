...
/**
 * <p>Original spec-file module name: hayai_annotation</p>
 * <pre>
 * A KBase module: hayai_annotation
 * </pre>
 */
public class HayaiAnnotationClient {
     ...
     */
    public HayaiAnnotationClient(URL url) {
     ...
     * validity.
     */
    public HayaiAnnotationClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public HayaiAnnotationClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public HayaiAnnotationClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("hayai_annotation.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
